...
_LOCAL_REFERENCE_FILES: Dict[str, list] = {
    ...
    "Philip Smith": ["Philip_Smith.jpg"],
    "Johannes C. Walter": ["Johannes_C__Walter.jpg"],
    "Andrea F. Young": ["Andrea_F__Young.jpg"],
    "Michael K. Rosen": ["Michael_K__Rosen.jpg"],
    "Joseph S. Takahashi": ["Joseph_S__Takahashi.jpg"],
    "William A. Tisdale": ["William_A__Tisdale.png"],
    "Stanley Cohen": ["Stanley_Cohen.jpg"],
    "Steven Holdcroft": ["Steven_Holdcroft.jpg"],
    "Pablo Laguna": ["Pablo_Laguna.jpg"],
    "Cheng Chin": ["Cheng_Chin.jpg"],
    "Jeffrey C. Smith": ["Jeffrey_C__Smith.jpg"],
    "Tristan Bridges": ["Tristan_Bridges.png"],
    "Michael P. Murphy": ["Michael_P__Murphy.jpg"],
    "Yifan Cheng": ["Yifan_Cheng.jpg"],
    "Robert Coleman Richardson": ["Robert_Coleman_Richardson.jpg"],
    "Kara L. Bren": ["Kara_L__Bren.jpg"],
    "Emmanuel Mignot": ["Emmanuel_Mignot.jpg"],
    "Ronald C. Cohen": ["Ronald_C__Cohen.jpg"],
    "Shana O. Kelley": ["Shana_O__Kelley.jpg"],
    "Sarah Helen Tolbert": ["Sarah_Helen_Tolbert.jpg"],
    "Jeffrey I. Gordon": ["Jeffrey_I__Gordon.jpg"],
    "David Edward Campbell": ["David_Edward_Campbell.jpg"],
    "Werner Kühlbrandt": ["Werner_Kühlbrandt.jpg"],
    "Joop Schaye": ["Joop_Schaye.jpg"],
    "Dimitri A. Antoniadis": ["Dimitri_A__Antoniadis.jpeg"],
    "Katherine Louise Bouman": ["Katherine_Louise_Bouman.jpg"],
    "David F. Labaree": ["David_F__Labaree.jpg"],
    "Anthony Rex Hunter": ["Anthony_Rex_Hunter.jpg"],
    "Clive Dickinson": ["Clive_Dickinson.jpg"],
    "Alain Aspect": ["Alain_Aspect.jpg"],
    "Benjamin Franklin": [
